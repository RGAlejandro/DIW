...
<form class="formulario" action="actualizarFotoPerfil.php" method="post" enctype="multipart/form-data">
                    <?php
                    ...
                    <button class="btn btn-actualizar w-100 mt-3" type="submit" value="actualizar">Actualizar</button>
                </form>
</body>
</html>
