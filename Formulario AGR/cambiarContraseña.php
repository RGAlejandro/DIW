...
if(isset($_GET['error']) && $_GET['error']=="contraseña_incorrecta"){
  echo "<div class='alert alert-danger' id='passAlert' role='alert'>Contraseñas NO son Iguales</div>";

}
if(isset($_GET['error']) && $_GET['error']=="contraseña_corta"){
    echo "<div class='alert alert-danger' id='passAlert' role='alert'>Contraseña nueva NO CUMPLE REQUISITOS MINIMOS</div>";
